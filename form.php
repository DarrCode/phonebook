    ...
    <div class="modal-content">
      ...
      <form id="addform" method="POST" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="message-text" class="col-form-label">Prefix:</label>
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1"><i class="fa fa-envelope-o"
                    aria-hidden="true"></i></span>
              </div>
              <input type="phone" class="form-control" id="prefix" name="prefix" required="required"maxLength="2" minLength="2">
            </div>
          </div>
          <div class="form-group">
