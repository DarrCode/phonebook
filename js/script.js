...
function getplayerrow(player) {
  ...
  if (player) {
    playerRow = `<tr>
          ...
          <td class="align-middle">${player.prefix}</td>
    ...
    $.ajax({
      ...
      success: function (player) {
        if (player) {
          ...
          $("#prefix").val(player.prefix);
          $("#phone").val(player.number);
        ...
        if (player) {
          const profile = `<div class="row">
                ...
                <div class="col-sm-6 col-md-8">
                  <h4 class="text-primary">${player.name}</h4>
                  <p class="text-secondary">
                   +${player.prefix}
                  </p>
                  <p class="text-secondary">
                    <i class="fa fa-phone" aria-hidden="true"></i> ${player.number}
                  </p>
                </div>
              </div>`;
